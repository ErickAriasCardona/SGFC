...
>>>>>>> fdf88aeded74558a458e4ea7c6e500d82a36bace
  ...
  const handleFilterChange = (e) => {
    ...
    const filteredByState = filtered.filter((instructor) => {
      ...
      if (
        ...
        instructor.estado.toLowerCase() === "inactivo"
      ) {
        return true;
      }
      return false;
  ...
  const showModalCreateInstructor = () => {
    const modalCreateInstructor = document.getElementById(
      "modal-overlayCreateInstructor"
    );
    if (modalCreateInstructor) {
      modalCreateInstructor.style.display = "flex"; // Cambia el display a flex para mostrar el modal
    }
  ...
  if (acces_granted) {
    return (
      <>
          ...
          <div className="container_GestionsInstructor">
            ...
            <div className="containerGestionsInstructorOptions">
              <div className="containerConsultInstructor">
                ...
                <button
                  className="btn_createInstructor"
                  onClick={showModalCreateInstructor}
                >
                  Agregar Instructor
                </button>
              </div>
                      ...
                      [0].map((offset) => {
                        ...
                        return (
                          ...
                          >
                            <img
                              src={
                                instructor?.foto_perfil || "default-profile.png"
                              } // Imagen del instructor
                              alt="Instructor"
                              className="carousel-image"
                            />
        ...
        {selectedInstructor && (
          <UpdateInstructor instructor={selectedInstructor} />
        )}
