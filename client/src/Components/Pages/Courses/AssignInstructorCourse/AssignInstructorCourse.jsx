                    ...
                    <div className="carousel-container_2">
                            ...
                            {filteredInstructors.length === 0 ? (
                                ...
                                filteredInstructors.length === 1 ? (
                                    <div className="carousel-card card-center">
                                        <img
                                            src={filteredInstructors[0]?.foto_perfil || 'default-profile.png'}
                                            alt="Instructor"
                        ...
                        {filteredInstructors.length > 0 && (
                            <div className="instructor-info">
                                <h3>
                                    {filteredInstructors[(current + 1) % filteredInstructors.length]?.nombres}{" "}
                                    {filteredInstructors[(current + 1) % filteredInstructors.length]?.apellidos}
                                </h3>
                                <p>{filteredInstructors[(current + 1) % filteredInstructors.length]?.titulo_profesional}</p>
                                <button
                                    className="profile-btn"
                                    onClick={() =>
                                        asignarInstructor(filteredInstructors[(current + 1) % filteredInstructors.length]?.ID)
                                    }
                                >
                                    Asignar Instructor
                                </button>
